					...
					<div class="col-sm-12">
						<div class="well" style="color: white">
							...
							<p>Se coge los tres limones partidos en cruz, se exprimen en
								una taza grande, se agrega una cucharada de azúcar, se baña con
								esto a las seis de la tarde hora de crepúsculo y se juaga solo
								con agua, no se debe usar jabon o shammpo, los limones los tiras
								a la basura en la bolsa transparente, esto te dara suerte
								rápida; debes complementar este ritual con la siguiente oración
								"tu secreto es especial y nunca nada te fallara, no hay
								comparación alguna, me libras de todo mal y me traes fortuna"</p>
